import type { CircleFlags, Fa6Brands, Fa6Solid, Ri, SimpleIcons, Logos, Mdi, VscodeIcons, Carbon } from 'iconify-icon-names';
 ...
 */
export type IconName = Fa6Brands | Fa6Solid | SimpleIcons | CircleFlags | Ri | Logos | Mdi | VscodeIcons | Carbon;
